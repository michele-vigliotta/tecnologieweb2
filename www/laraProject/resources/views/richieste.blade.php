  ...
  <section class="client_section layout_padding">
    <div class="container-fluid">
      <div class="heading_container psudo_white_primary mb_45">
        ...
        @if(!empty($richiesteattive))
            @foreach ($richiesteattive as $richiesta)
              <div class="col-sm-62">
                  <h4 class="faq-question">Id richiesta: {{ $richiesta->id_prenotazione }}<br> 
                      Data prenotazione: {{ $richiesta->data_prenotazione }}</h4>
         ...
         @else
            <div class="col-sm-6 col-md-4">
              <div class='detail-box'>
                <h4>Nessuna richiesta ricevuta per questo annuncio.</h4>
              </div>
            </div>
          @endif
        ...
        @if(!empty($richiesteaccettate))
            @foreach ($richiesteaccettate as $richiesta)
              <div class="col-sm-62">
                <h4 class="faq-question">Id richiesta: {{ $richiesta->id_prenotazione }} Accettata in data {{ $richiesta->data_conferma}}</h4>
